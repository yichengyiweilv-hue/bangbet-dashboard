  ...
  var STORE = {
    ...
    months: {
      ...
      '2025-10': {
        ...
        '2025-11': {
        'm1-registration': ' 肯尼亚和坦桑因为买量增量明细，自然量占比下降。加纳因为刷子导致自然量猛增。尼日自然量略有下降。 ',
        'm2-payrate': ' 依旧是只有加纳自然量付费率高于买量，其他各国买量用户付费率更好。 ',
        'm3-arppu': '与付费率相反，只有加纳的买量用户arppu高于自然量，其他国家都是自然量人均付费更高。本月加纳自然量arppu下降也与刷子拉低平均值有关。 ',
        'm4-betflow-percapita': '与arppu高度正相关 ' ,
        'm5-player-mix': '加纳体育用户占比提高主要是GH 体育优惠卷 bug，肯尼亚双端都偏游戏。坦桑买量偏游戏，自然量的体育用户更多 ' ,
        'm6-retention': '自然量用户留存明细高于买量，加纳的7留自然量异常还是刷子导致。 '
      },

      // 12月填这里
        '2025-12': {
        'm1-registration': '肯尼亚的自然量日波动更明显，但绝对量级最大。加纳到27号有一个自然量的异常峰值',
        'm2-payrate': ' 肯尼亚和坦桑买量付费率比自然量付费率明细更高，12月26、27日分别出现买量和自然量付费率极大值，可能与圣诞有关。',
        'm3-arppu': '本月加纳自然量arppu恢复，高于买量，其他国家也是自然量付费用户人均充值更高。',
        'm4-betflow-percapita': '与arppu高度正相关 ' ,
        'm5-player-mix': '肯尼亚双端都有很强的游戏向，尼日相反，买量和自然量都偏体育。 ' ,
        'm6-retention': '自然量用户留存依旧明显高于买量，单日点留存仅供参考。 '
      },
